...
int kprofiler::binary::registerNatives(JNIEnv *env) {
  auto clazz = env->FindClass("com/knightboost/kprofiler/atrace/BinaryTrace");
  if (clazz) {
    {
      JNINativeMethod t[] = {
          {
...
Java_com_knightboost_kprofiler_atrace_BinaryTrace_nativeInit(JNIEnv *env, jclass clazz,
                                                           jstring filepath) {
  kprofiler::thread_name_collector::start();
...
extern "C"
JNIEXPORT void JNICALL
Java_com_knightboost_kprofiler_atrace_BinaryTrace_nativeStop(JNIEnv *env, jclass clazz) {
  ...
  kprofiler::thread_name_collector::stop();
}


extern "C"
JNIEXPORT jstring JNICALL
Java_com_knightboost_kprofiler_atrace_BinaryTrace_nativeGetThreadsInfo(JNIEnv *env, jclass clazz) {
  auto result = kprofiler::thread_name_collector::dump();
